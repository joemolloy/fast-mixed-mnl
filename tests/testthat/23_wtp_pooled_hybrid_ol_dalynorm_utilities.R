...
P_indic_1 = ( exp(0 - @C_1 - 1* LV )/(1 ))  * $car8_1;

P_indic_2 = ( exp(0 - @C_2 - @THETA_2* LV )/(1)) * $car13_1;

P_indic_3 = ( exp(0 - @C_3 - @THETA_3* LV )/(1))  * $car21_1;

P_indic_4 = ( exp(0 - @C_4 - @THETA_4* LV )/(1))  * $car23_1;

P_indic_5 = ( exp(0 - @C_5 - @THETA_5* LV )/(1))  * $pt3_1;
